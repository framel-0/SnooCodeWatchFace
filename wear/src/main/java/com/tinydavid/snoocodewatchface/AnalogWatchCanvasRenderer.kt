...
import com.tinydavid.snoocodewatchface.domain.model.WatchFaceData
import com.tinydavid.snoocodewatchface.domain.utils.WatchFaceColorPalette.Companion.convertToWatchFaceColorPalette
import com.tinydavid.snoocodewatchface.utils.DRAW_HOUR_PIPS_STYLE_SETTING
import com.tinydavid.snoocodewatchface.utils.WATCH_HAND_LENGTH_STYLE_SETTING
...
//        canvas.drawColor(backgroundColor)
        val bitmap =
            if (roundScreen) {
                BitmapFactory.decodeResource(context.resources, R.drawable.wallpapper1a)
            } else {
                BitmapFactory.decodeResource(context.resources, R.drawable.wallpapper)
            }
